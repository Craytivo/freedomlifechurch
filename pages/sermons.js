...
const SermonsPage = () => {
  ...
  const formatDuration = (duration) => {
    // Convert YouTube duration format (PT1H2M10S) to readable format
  ...
  return (
    <>
      <Head>
        <title>Sermons | Freedom Life Church</title>
        <meta name="description" content="Watch and listen to powerful sermons from Freedom Life Church. Access our complete library of messages, teachings, and worship services." />
        <meta name="keywords" content="sermons, messages, teachings, Freedom Life Church Edmonton, Pastor Mike, church services, online church" />
        <meta property="og:title" content="Sermons | Freedom Life Church" />
        <meta property="og:description" content="Watch and listen to powerful sermons from Freedom Life Church. Access our complete library of messages, teachings, and worship services." />
            ...
            <>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {currentSermons.map((sermon) => (
                  <div key={sermon.id} className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                    {/* Thumbnail */}
                    <div className="relative aspect-video overflow-hidden">
                      ...
                      <div className="absolute top-2 left-2">
                        <span className="px-2 py-1 bg-blue-500/90 text-white text-xs font-medium rounded-full">
                          {categories.find(cat => cat.value === sermon.category)?.label || 'Teaching'}
                        </span>
                      </div>
                    </div>
                    ...
                    {/* Content */}
                    <div className="p-4">
                      <h3 className="font-semibold text-primary-900 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors">
                        {sermon.title}
                      </h3>
