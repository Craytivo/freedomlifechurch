...
// Plan a Visit section tailor              <h2 className="mt-3 font-heading text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 mb-4 drop-shadow-md leading-[1.1]">
                Plan Your Visit
              </h2>
        ...
        <div className="grid lg:grid-cols-12 gap-14 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            <div className="mb-8">
              ...
              <h2 className="mt-3 font-heading text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-primary-900 mb-4">
                Plan Your Visit
              </h2>
